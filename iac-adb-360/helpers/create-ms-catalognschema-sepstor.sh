...
then
    ...
    databricks grants update external_location $extlocationname --json '{ "changes": [{"principal": "a1a2e639-2470-4a50-b6c2-7f9de92563bd", "add" : ["ALL_PRIVILEGES"]}] }'
else
...
then
    ...
    # databricks grants update catalog $catname --json '{ "changes": [{"principal": "a1a2e639-2470-4a50-b6c2-7f9de92563bd", "add" : ["ALL_PRIVILEGES"]}] }'
